...
迁移做完后，生成一段可以直接转发给玩家的话，**用玩家视角写**：

- 不出现 Steam ID、集合名、字段名，也不讲是怎么做到的
- 不逐项列数值。要玩家自己进游戏看，而不是拿着清单核对
- 点出该看哪几样东西，以及发现不对怎么反馈
- 三两句话，不寒暄

模板：

> 你的数据已经转到新账号了。进游戏看一下勇士积分、会员、属性加点和英雄觉醒对不对，有问题随时找我。

会员如果已经过期，补一句说明，免得玩家以为是迁移弄丢的：

> 会员在迁移前就已经到期了，这次只是把记录原样转过去，没有变动。
