...
export const PROPERTY_LIST: PropertyDef[] = [
  ...
  { name: 'property_aoe_bonus_constant_stacking', group: 'instant', valuePerLevel: 15, levelPerStep: 1, barCells: 8, signed: true, Icon: Target },
  { name: 'property_health_regen_percentage', group: 'instant', valuePerLevel: 0.3, levelPerStep: 1, barCells: 8, unit: '%', Icon: FlaskRound },
  { name: 'property_mana_regen_total_percentage', group: 'instant', valuePerLevel: 0.3, levelPerStep: 1, barCells: 8, unit: '%', Icon: TestTubeDiagonal },
  ...
  { name: 'property_cast_range_bonus_stacking', group: 'scaling', valuePerLevel: 25, levelPerStep: 1, barCells: 8, signed: true, Icon: Radius },
  ...
  { name: 'property_incoming_damage_percentage', group: 'scaling', valuePerLevel: 4, levelPerStep: 1, barCells: 8, unit: '%', Icon: BrickWallShield },
  { name: 'property_attack_range_bonus', group: 'scaling', valuePerLevel: 25, levelPerStep: 1, barCells: 8, signed: true, Icon: BowArrow },
  { name: 'property_physical_armor_bonus', group: 'scaling', valuePerLevel: 5, levelPerStep: 1, barCells: 8, signed: true, Icon: Shield },
  { name: 'property_preattack_bonus_damage', group: 'scaling', valuePerLevel: 15, levelPerStep: 1, barCells: 8, signed: true, Icon: Sword },
  { name: 'property_attackspeed_bonus_constant', group: 'scaling', valuePerLevel: 15, levelPerStep: 1, barCells: 8, signed: true, Icon: Hand },
