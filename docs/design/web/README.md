...
| 11 可点击元素与玩家页细节 | 无 | 按钮手型光标、属性页等级入口加箭头、个人主页会员状态并入身份卡，见 [phase-11-clickable-polish.md](phase-11-clickable-polish.md) | 设计中 |
| 11 可点击元素与玩家页细节 | 无 | 按钮手型光标、属性页等级入口加箭头、个人主页会员状态并入身份卡，见 [phase-11-clickable-polish.md](phase-11-clickable-polish.md) | 设计已定，等批次 10 |
| 12 配色与控件 | 无 | 配色分工、网站主色、功能色与品牌色，见 [phase-12-color-system.md](phase-12-color-system.md)；按钮体系、登录等待、头部退出，见 [phase-12-controls.md](phase-12-controls.md) | 设计中 |
